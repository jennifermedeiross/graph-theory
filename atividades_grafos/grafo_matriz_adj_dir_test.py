...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #Grafos test dijkstra
        self.g_dk1 = MeuGrafo()
        self.g_dk1.adiciona_vertice('J')
        self.g_dk1.adiciona_vertice('T')
        self.g_dk1.adiciona_vertice('C')
        self.g_dk1.adiciona_vertice('D')
        self.g_dk1.adiciona_vertice('E')
        self.g_dk1.adiciona_vertice('P')
        self.g_dk1.adiciona_aresta('a1', 'J', 'T', 2)
        self.g_dk1.adiciona_aresta('a2', 'J', 'C', 1)
        self.g_dk1.adiciona_aresta('a3', 'C', 'D', 3)
        self.g_dk1.adiciona_aresta('a4', 'T', 'D', 1)
        self.g_dk1.adiciona_aresta('a5', 'C', 'P', 8)
        self.g_dk1.adiciona_aresta('a6', 'D', 'E', 2)
        self.g_dk1.adiciona_aresta('a7', 'E', 'P', 3)

        self.g_dk2 = MeuGrafo()
        self.g_dk2.adiciona_vertice("A")
        self.g_dk2.adiciona_vertice("B")
        self.g_dk2.adiciona_vertice("C")
        self.g_dk2.adiciona_vertice("D")
        self.g_dk2.adiciona_aresta('a1', 'A', 'B', 1)
        self.g_dk2.adiciona_aresta('a2', 'A', 'C', 3)
        self.g_dk2.adiciona_aresta('a3', 'B', 'D', 1)
        self.g_dk2.adiciona_aresta('a2', 'C', 'D', 2)

        self.g_dk3 = MeuGrafo()
        self.g_dk3.adiciona_vertice('A')
        self.g_dk3.adiciona_vertice('B')
        self.g_dk3.adiciona_vertice('C')
        self.g_dk3.adiciona_vertice('D')
        self.g_dk3.adiciona_vertice('E')
        self.g_dk3.adiciona_vertice('F')
        self.g_dk3.adiciona_aresta('a1', 'A', 'B', 4)
        self.g_dk3.adiciona_aresta('a3', 'A', 'C', 3)
        self.g_dk3.adiciona_aresta('a2', 'B', 'C', 2)
        self.g_dk3.adiciona_aresta('a4', 'C', 'D', 4)
        self.g_dk3.adiciona_aresta('a5', 'D', 'E', 1)
        self.g_dk3.adiciona_aresta('a6', 'B', 'E', 9)
        self.g_dk3.adiciona_aresta('a7', 'E', 'F', 2)

        self.g_dk4 = MeuGrafo()
        self.g_dk4.adiciona_vertice('A')
        self.g_dk4.adiciona_vertice('B')
        self.g_dk4.adiciona_vertice('C')
        self.g_dk4.adiciona_vertice('D')
        self.g_dk4.adiciona_aresta('a1', 'A', 'B', 7)
        self.g_dk4.adiciona_aresta('a2', 'A', 'C', 2)
        self.g_dk4.adiciona_aresta('a3', 'B', 'D', 1)
        self.g_dk4.adiciona_aresta('a4', 'C', 'D', 6)
        self.g_dk4.adiciona_aresta('a5', 'A', 'D', 9)
        self.g_dk4.adiciona_aresta('a6', 'C', 'B', 3)

        self.g_dk5 = MeuGrafo()
        self.g_dk5.adiciona_vertice("1")
        self.g_dk5.adiciona_vertice("2")
        self.g_dk5.adiciona_vertice("3")
        self.g_dk5.adiciona_vertice("4")
        self.g_dk5.adiciona_aresta('a1', '1', '2', 2)
        self.g_dk5.adiciona_aresta('a2', '1', '3', 4)
        self.g_dk5.adiciona_aresta('a3', '2', '3', 1)
        self.g_dk5.adiciona_aresta('a4', '2', '4', 7)
        self.g_dk5.adiciona_aresta('a5', '3', '4', 3)

        self.g_dk6 = MeuGrafo()
        self.g_dk6.adiciona_vertice("A")
        self.g_dk6.adiciona_vertice("B")
        self.g_dk6.adiciona_vertice("C")
        self.g_dk6.adiciona_vertice("D")
        self.g_dk6.adiciona_vertice("E")
        self.g_dk6.adiciona_aresta('a1', 'A', 'B', 5)
        self.g_dk6.adiciona_aresta('a2', 'A', 'C', 2)
        self.g_dk6.adiciona_aresta('a3', 'B', 'C', 3)
        self.g_dk6.adiciona_aresta('a4', 'B', 'D', 7)
        self.g_dk6.adiciona_aresta('a5', 'C', 'D', 1)
        self.g_dk6.adiciona_aresta('a6', 'C', 'E', 4)
        self.g_dk6.adiciona_aresta('a7', 'D', 'E', 3)

        self.g_dk7 = MeuGrafo()
        self.g_dk7.adiciona_vertice('V')
        self.g_dk7.adiciona_vertice('W')
        self.g_dk7.adiciona_vertice('X')
        self.g_dk7.adiciona_vertice('Y')
        self.g_dk7.adiciona_vertice('Z')
        self.g_dk7.adiciona_aresta('a1', 'V', 'W', 3)
        self.g_dk7.adiciona_aresta('a2', 'V', 'X', 2)
        self.g_dk7.adiciona_aresta('a3', 'V', 'Y', 1)
        self.g_dk7.adiciona_aresta('a4', 'W', 'Y', 4)
        self.g_dk7.adiciona_aresta('a5', 'W', 'Z', 2)
        self.g_dk7.adiciona_aresta('a6', 'X', 'Z', 3)
        ...
        self.eng_comp_ordTop = ['Pré-Cálculo', 'Inglês Instrumental', 'Introdução à Engenharia de Computação', 'Algoritmos e Programação',
                           'Lab. de Algoritmos e Programação', 'Sistemas Digitais I', 'Medição Eletro-eletrônica', 'Estatística Aplicada à Computação',
                           'Leitura e Produção de Textos', 'Educação Ambiental e Sustentabilidade', 'Relações Humanas no Trabalho', 'Metodologia da Pesquisa Científica',
                           'Libras', 'Desenho Assistido por Computador', 'Empreendedorismo de Base Tecnológica', 'Educação em Direitos Humanos', 'Educação em Diversidade',
                           'Cálculo I', 'Estruturas de Dados e Algoritmos', 'Laboratório de Estruturas de Dados e Algoritmos', 'Sistemas Digitais II',
                           'Programação Orientada a Objetos', 'Laboratório de Programação Orientada a Objetos', 'Técnicas de Prototipagem', 'Cálculo II',
                           'Teoria dos Grafos', 'Organização e Arquitetura de Computadores', 'Física Clássica', 'Teoria da Computação', 'Redes de Computadore',
                           'Bancos de Dados', 'Padrões de Projetos', 'Análise e Técnicas de Algoritmos', 'Projeto em Engenharia de Computação I', 'Sistemas Operacionais',
                           'Microprocessadores e Microcontroladores', 'Álgebra Linear Aplicada à Computação', 'Eletricidade e Eletromagnetismo', 'Inteligência Artificial',
                           'Sinais e Sistemas', 'Análise e Projeto de Sistemas', 'Teste de Software', 'Projeto em Engenharia de Computação II', 'Projeto de Sistemas Digitais',
                           'Métodos Numéricos', 'Circuitos Eletro-Eletrônicos', 'Gerência de Projetos', 'Sistemas Embarcados', 'Verificação Funcional de Sistemas Digitais',
        ...
        self.const_edificios_ordTop = ['Informática Básica', 'Inglês Instrumental', 'Português Instrumental', 'Química Aplicada', 'Cálculo Diferencial e Integral I',
                                  'Álgebra Vetorial e Geometria Analítica', 'Desenho Técnico', 'Introdução a Construção Edifícios', 'Metodologia da Pesquisa Científica',
                                  'Matemática Financeira Aplicada', 'Instalações Especiais', 'Formação do Empreendedor', 'Legislação Aplicada', 'Relações Humanas no Trabalho',
                                  'Trabalho de Conclusão de Curso', 'Estágio Supervisionado', 'Libras (optativa)', 'Física I', 'Materiais de Construção I', 'Des. Assist. por Computador I',
                                  'Cálculo Diferencial e Integral II', 'Topografia I', 'Desenho e Projeto Arquitetônico', 'Estatística Aplicada', 'Gestão Ambiental', 'Administração de Custos',
                                  'Resistência dos Materiais', 'Física II', 'Técnicas Construtivas I', 'Topografia II', 'Materiais de Construção II', 'Des. Assist. por Computador II',
                                  'Instalações Hidrossanitárias', 'Instalações Elétricas Pred.', 'Especificações e Orcamentos I', 'Segurança do Trabalho', 'Técnicas Construtivas II',
                                  'Estruturas de Concreto I', 'Mecânica dos Solos', 'Estruturas Metálicas', 'Estruturas de Madeira', 'Especificações e Orcamentos II', 'Planej. Gestão e Controle de Obra',
                                  'Avaliação Pós-ocupação', 'Patologia das Construções', 'Manutenção Predial', 'Fundações e Sistemas de Contenção', 'Estruturas de Concreto II',
        ...
        self.fisica_ordTop = [
            'Introdução à Física', 'Pré-Cálculo', 'Psicologia da Aprendizagem', 'Álgebra Vetorial e Geometria Analítica',
            'Língua Portuguesa I', 'Metodologia do Trabalho Científico', 'História da Educação',
            'Inglês Instrumental', 'Filosofia da Educação', 'Química Geral', 'Sociologia da Educação',
            'Educação em Direitos Humanos', 'Educação Ambiental e Sustentabilidade', 'Didática Geral',
            'Políticas e Gestão Educacional', 'Prática de Ensino I', 'Educação em Diversidade', 'Optativa I',
            'Optativa II', 'Física Básica I', 'Física Experimental I', 'Cálculo Diferencial e Integral I',
            'Álgebra Linear', 'Língua Portuguesa II', 'Didática Aplicada ao Ensino de Física', 'Prática de Ensino II',
            'Libras', 'Física Básica II', 'Física Experimental II', 'Cálculo Diferencial e Integral II',
        ...
        self.matematica_ordTop = ['Matemática para o Ensino Médio 1', 'Matemática para o Ensino Fundamental', 'Trigonometria',
                             'História da Educação', 'Psicologia da Aprendizagem', 'Língua Portuguesa 1', 'Inglês Instrumental',
                             'Álgebra Vetorial e Geometria Analítica', 'Epistemologia da Matemática', 'Filosofia da Educação',
                             'Educação em Diversidade', 'Sociologia da Educação', 'Didática Geral', 'Metodologia do Trabalho Científico',
                             'Gestão Educacional e Planejamento', 'Educação em Direitos Humanos', 'Optativa 1', 'Educação Ambiental e Sustentabilidade',
                             'Optativa 2', 'Matemática para o Ensino Médio 2', 'Cálculo 1', 'Língua Portuguesa 2', 'Argumentação Matemática',
                             'Prática de Laboratório de Ensino de Matemática 1', 'Didática da Matemática', 'Libras 1', 'Desenho Geométrico',
                             'Pesquisa Aplicada em Matemática 1', 'Matemática para o Ensino Médio 3', 'Cálculo 2', 'Álgebra Linear 1',
                             'Prática de Laboratório de Ensino de Matemática 2', 'Introdução a Teoria dos Números', 'Geometria Euclidiana Plana',
                             'Matemática Financeira 1', 'Pesquisa Aplicada em Matemática 2', 'Cálculo 3', 'Física Básica 1', 'Prática de Ensino de Matemática 1',
                             'Introdução à Programação', 'Estágio Supervisionado 1', 'Estruturas Algébricas 1', 'Estatística e Probabilidade',
                             'Geometria Euclidiana Espacial', 'TCC', 'História da Matemática', 'Prática de Ensino de Matemática 2', 'Estágio Supervisionado 2',
                             'Análise Real 1', 'Equações Diferenciais Ordinárias', 'Prática de Ensino de Matemática 3', 'Estágio Supervisionado 3',
        ...
        self.letras_ordTop = ['Introdução aos Estudos Literários', 'Introdução à Linguistica', 'Leitura e Produção de Texto I', 'Informática Básica',
                         'Fundamentos da Educação a Distância', 'Inglês Instrumental', 'História da Educação Brasileira', 'Fundamentos da Linguística Românica',
                         'Metodologia da Pesquisa Científica', 'Psicologia da Aprendizagem', 'Seminário de Pesquisa Interdisciplinar I', 'Didática',
                         'Língua Brasileira de Sinais (LIBRAS)', 'Educação Inclusiva', 'Gestão Educacional', 'Tópicos em Projetos Especiais', 'Educação e Direitos Humanos',
                         'Educação Ambiental e Interdisciplinaridade', 'Teoria Literária I', 'Literatura e Ensino', 'Morfologia da Língua Portuguesa', 'Linguística I',
                         'Filosofia da Educação', 'História da Língua Portuguesa', 'Seminário de Pesquisa Interdisciplinar II', 'Leitura e Produção de Texto II',
                         'Orientação de Estágio Supervisionado I', 'Seminário de Pesquisa Interdisciplinar III', 'Seminário de Pesquisa Interdisciplinar IV',
                         'Estrutura e Funcionamento da Educ. Básica', 'Língua Portuguesa como segunda língua para surdos (Optativa)', 'Sociologia da Educação',
                         'Teoria Literária II', 'Literatura Brasileira I', 'Literatura Portuguesa I', 'Linguística II', 'Fonética e Fonologia da Língua Portuguesa',
                         'Aquisição da Linguagem', 'Metodologia do Ensino de Literatura', 'Orientação de Estágio Supervisionado II', 'Estágio Supervisionado I',
                         'Orientação de TCC I', 'Literatura Brasileira II', 'Literatura Portuguesa II', 'Morfossintaxe', 'Literatura Brasileira III', 'Semântica da Lingua Portuguesa',
                         'Metodologia do Ensino de Língua Portuguesa', 'Literatura Brasileira IV', 'Literaturas Africanas de Língua Portuguesa', 'Sociolinguística', 'Literatura Brasileira V',
                         'Literatura Infantil e juvenil', 'Literatura e Cultura Popular', 'Orientação de Estágio Supervisionado III', 'Pragmática', 'Estágio Supervisionado II',
                         'Orientação de TCC II', 'Orientação de Estágio Supervisionado IV', 'Estágio Supervisionado III']
        ...
        self.telematica_ordTop = ['Introdução à Telemática', 'Fundamentos de Eletricidade', 'Programação I', 'Lab. de Sist. Abertos', 'Inglês Instrumental',
                             'Pré-cálculo', 'Língua Portuguesa', 'Arquitetura de Computadores', 'Educação em Diversidade', 'Metodologia da Pesquisa Científica',
                             'Educação Ambiental e Sustentabilidade', 'Formação do Empreendedor', 'Optativa I', 'Educação em Direitos Humanos', 'Relações Humanas no Trabalho',
                             'Ética', 'Optativa II', 'Redes de Computadores', 'Eletrônica para Telecomunicações', 'Medição Eletroeletrônica', 'Programação II',
                             'Cálculo Diferencial e Integral', 'Administração de Sistemas', 'Sistemas Operacionais', 'Tecnologias de Redes Locais', 'Estatística Aplicada à Telemática',
                             'Sinais e Sistemas', 'Programação III', 'Administração de Serviços', 'Interconexão de Redes', 'Cabeamento Estruturado', 'Teoria da Informação e Codificação',
                             'Sistemas de Comunicações', 'Processamento Digital de Sinais', 'Redes de Longa Distância', 'Segurança de Redes de Computadores', 'Comunicações Sem Fio',
                             'Comunicações Ópticas', 'Projeto em Telemática', 'Estágio Supervisionado (Optativa)', 'Projeto de Redes de Computadores', 'Sistemas Telefônicos',
    ...
    def test_dijkstra(self):
        self.assertEqual(self.g_dk1.dijkstra('J', 'P'), ['P', 'E', 'D', 'T', 'J'])
        self.assertEqual(self.g_dk2.dijkstra('A', 'D'), ['D', 'B', 'A'])
        self.assertEqual(self.g_dk3.dijkstra('A', 'F'), ['F', 'E', 'D', 'C', 'A'])
        self.assertEqual(self.g_dk4.dijkstra('A', 'D'), ['D', 'B', 'C', 'A'])
        self.assertEqual(self.g_dk5.dijkstra('1', '4'), ['4', '3', '2', '1'])
        self.assertEqual(self.g_dk6.dijkstra('A', 'E'), ['E', 'C', 'A'])
        self.assertEqual(self.g_dk7.dijkstra('V', 'Z'), ['Z', 'X', 'V'])

    def test_khan(self):
        self.assertEqual(self.eng_comp.khan(), self.eng_comp_ordTop)
        self.assertEqual(self.const_edificios.khan(), self.const_edificios_ordTop)
